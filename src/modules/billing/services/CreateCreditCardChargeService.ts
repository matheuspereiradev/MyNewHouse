...
import IGenetateCharge from '../infra/providers/charges/model/IGenerateCreditCardCharge';
...
@injectable()
class CreateCreditCardChargeService {
...
export { CreateCreditCardChargeService };